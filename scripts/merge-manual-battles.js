...
//   clan_results_table
//
// Generated fields win only when they exist:
//   first_snapshot
//   last_snapshot
//   total_snapshots
//   total_rows
...
async function main() {
  ...
  const tableBacked = finalRecords.filter(r => r.nong_results_table);

  console.log("Table-backed battles after merge:");
  for (const battle of tableBacked) {
    console.log(`  ${battle.battle} (${battle.display_name}) -> ${battle.nong_results_table}`);
  }
}
