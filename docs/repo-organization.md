...
| `pages/tools/ps99-version-history.html` | `ps99-version-history.html` | PS99 place version catalog and history |
...
| `pages/tools/loadout-optimizer.html` | `loadout-optimizer.html` | PS99 enchant loadout, egg, damage, and drop optimizer |
